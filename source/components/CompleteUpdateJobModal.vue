<template>
  <!-- Modal -->
  <div class="modal fade" id="completeUpdateJobModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content box-modal">
        <div class="modal-header border-0">
          <img
            ...
            aria-label="Close"
            id="closeCompleteUpdateJobModal"
...
<script>
  export default {
    name: "CompleteUpdateJobModal",
  }
</script>

<style lang="scss" scoped>
  @import "../styles/components/_complete_create_job_modal.scss";
</style>
