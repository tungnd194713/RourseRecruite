    ...
    <div class="card detail-job-card position-relative preview_job">
      ...
      <div class="detail-job-content py-3">
        ...
        <div class="d-flex justify-content-end footer">
          <button id="btn_back" class="btn" @click="backToUpdateJobPage">Quay lại</button>
          <button id="btn_completion" class="btn" :disabled="isDisabledSaveBtn" @click="completeUpdateJob">Hoàn tất</button>
          <button
